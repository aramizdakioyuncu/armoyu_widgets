              ...
              children: [
                ...List.generate(
                  ...
                  (postIndex) {
                    ...
                    //Comment Button
                    var postcommentIcon =
                        const Icon(Icons.comment_outlined).obs;
                              ...
                              child: Column(
                                children: [
                                  SizedBox(
                                    ...
                                    child: Stack(
                                      children: [
                                        ...
                                        ...List.generate(
                                            postdetail.value.firstlikers!
                                                .length, (index) {
                                          int left = postdetail.value
                                                      .firstlikers!.length *
                                                  10 -
                                              (index + 1) * 10;
                                          return Obx(
                                        ...
                                        Obx(
                                          () => Positioned(
                                            left: postdetail.value.firstlikers!
                                                    ...
                                                    10 +
                                                15,
                                            child: postdetail.value.firstlikers!
                                                    .isNotEmpty
                                                ? GestureDetector(
                                                    onTap: () => controller
                                                        .showpostlikers(
                                  ...
                                  Obx(
                                    () => Column(
                                      children: List.generate(
                                          postdetail.value.firstcomments!
                                              .length, (index) {
                                        return PostcommentView.commentlistv2(
                                          context,
                                          postdetail
                                              .value.firstcomments![index],
                                          service,
                                          profileFunction: profileFunction,
                                        );
                                      }),
                                  ...
                                  Obx(
                                    () => Visibility(
                                      visible:
                                          postdetail.value.commentCount > 3,
                                      child: Align(
