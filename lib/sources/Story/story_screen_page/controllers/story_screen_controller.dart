...
class StoryScreenController extends GetxController {
  ...
  StoryScreenController({required this.service});
  ...
  Future<void> storyview(Story story) async {
    ...
    ServiceResult response =
        await service.storyServices.view(storyID: story.storyID);
    if (!response.status) {
  ...
  Future<void> fetchstoryViewlist(int storyID) async {
    ...
    StoryViewListResponse response =
        await service.storyServices.fetchviewlist(storyID: storyID);
